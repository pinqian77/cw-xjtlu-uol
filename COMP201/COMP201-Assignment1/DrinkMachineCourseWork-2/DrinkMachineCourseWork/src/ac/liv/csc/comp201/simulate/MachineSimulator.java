...
public class MachineSimulator extends Thread implements IMachine  {
	 ...
	 */
	public void start(IMachineController controller,Tester tester) {
	...
	/* (non-Javadoc)
	 * @see ac.liv.csc.comp201.simulate.IMachineController#resetCoinHandler()
	 */
	@Override
	...
	private CountrySelector cselector=null;
	...
	private void initialize() {
		...
		cselector=new CountrySelector((IMachine)this);
